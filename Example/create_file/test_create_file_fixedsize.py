...
# File Name: test_create_file_fixedsize.py
# Description:
...
FILE_SIZE_KB = int(config.get('default','FILE_SIZE_KB'))
...
def write_file(path_store, file_index, dir_index):
    ...
    data=(str(random.randint(0,1024)).zfill(16)+ str(random.randint(0,1024)).zfill(16))* 32 * FILE_SIZE_KB
